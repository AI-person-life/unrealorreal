...
- [`docs/modszer.md`](docs/hu/modszer.md) — hogyan épül fel egy karakter a semmiből
- [`docs/hibak.md`](docs/hu/hibak.md) — **a leghasznosabb rész**: amit elrontottunk
- [`docs/eszkozok.md`](docs/hu/eszkozok.md) — a saját scriptek, amik közben születtek
- [`docs/etika.md`](docs/hu/etika.md) — hol húztuk meg a határt, és miért ott
